      ...
      <Container>
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-20">
          <div className="lg:col-span-6">
            ...
            <h1 className="mt-8 font-script text-display-sm leading-display text-primary">
              ...
              {highlights.map((treatment) => (
                <li key={treatment.slug} className="border-b border-hairline">
                  <Link
                    ...
                    className="group flex items-center justify-between gap-6 py-5 font-sans text-copy-lg text-ink transition-colors hover:text-primary"
                  >
                    {treatment.name}
